    ...
    <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
      <div className="w-1/2">
        ...
        <input
          ...
          value={amount}
          // && operator if no value is given The onchange event occurs when the value of an HTML element is changed. e.target.value most of the time gives string so number is used to change it to numbers
          onChange={(e) =>
